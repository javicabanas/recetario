...
- **Imprimible:** Cada receta tiene un formato optimizado para impresión
...
Platos de apertura que despiertan el apetito con sabores vibrantes.

- [Chilaquiles Verdes del Centro de México](entrantes/chilaquiles_verdes.md) - 35 min
- [Salpicón de Atún](entrantes/salpicon-de-atun.md) - 25 min + 30 min reposo
...
- [Cochinita Pibil](principales/Cochinita_Pibil.md) - 5-6h (+ 12h marinado) | 12 pax
...
La joya de la cocina valenciana: arroces con técnica tradicional.
...
Pequeñas delicias para compartir, esencia de la gastronomía española.

- [Ensaladilla Rusa Tradicional Española](tapas/ensaladilla-rusa.md) - 45 min (+ enfriado)
- [Huevos Rellenos Clásicos](tapas/huevos-rellenos.md) - 30 min

---

### 🥫 Guarniciones y Salsas (4 recetas)

Acompañamientos y bases fundamentales de la cocina mediterránea.

- [Alioli con Clara de Huevo](guarniciones_y_salsas/alioli_clara_huevo.md) - 5 min
- [Ali-oli Tradicional (All i Oli)](guarniciones_y_salsas/alioli_tradicional.md) - 25 min
- [Mojo de ajo a la veracruzana](guarniciones_y_salsas/mojo_de_ajo_veracruzano.md) - 20 min
- [Mojo de Ajo Veracruzano (Versión Simplificada)](guarniciones_y_salsas/mojo_de_ajo_veracruzano_v2.md) - 20 min
...
El dulce final que cierra cualquier comida con elegancia.

- [Arroz con Leche Asturiano - Estilo Casa Gerardo](postres/arroz-con-leche-asturiano.md) - 2h 40 min | 10-12 pax

---

## 🔍 Cómo Usar Este Recetario

1. **Navega por categorías** usando el menú lateral
2. **Busca recetas** con la barra de búsqueda (🔍)
3. **Imprime recetas** usando Ctrl+P o Cmd+P en cada página
4. **Consulta las notas del chef** para dominar técnicas clave
